...
public:
	...
	using ReadCallback = std::function<bool(std::shared_ptr<TcpConnection> conn, net::BufferReader& buffer)>;
...
protected:
	...
	std::unique_ptr<net::BufferReader> read_buffer_;
	std::unique_ptr<net::BufferWriter> write_buffer_;
